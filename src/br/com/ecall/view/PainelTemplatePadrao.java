...
public class PainelTemplatePadrao extends javax.swing.JFrame {

    public PainelTemplatePadrao() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PainelTemplatePadrao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PainelTemplatePadrao().setVisible(true);
            }
        });
    }
